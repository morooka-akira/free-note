...
var ya = au((fe)=>{
    "use strict";
    var go = su("react"), ae = su("scheduler");
    function v(e) {
...
` + l[u].replace(" at new ", " at ");
    ...
    var Pc = Fe && "TextEvent" in window && !pt, Jo = Fe && (!Mi || pt && 8 < pt && 11 >= pt), zu = " ", Pu = !1;
    function qo(e, n) {
        switch(e){
            case "keyup":
...
function App() {
    return mod3.createElement("div", null, mod3.createElement("h1", null, "Hello, world"));
}
const container = document.getElementById("root");
const root = mod2.createRoot(container);
root.render(mod3.createElement(App, null));
